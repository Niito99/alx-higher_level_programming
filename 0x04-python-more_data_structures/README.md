...
2. the second file in this dir contains code that searches a list and replaces specified elements in the list
3. the third file adds the unique integers in a list
4. the fourth file contains code that finds the elements common to two different sets
